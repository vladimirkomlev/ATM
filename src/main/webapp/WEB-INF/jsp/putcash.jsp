	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-12 col-sm-6 main-block">
				...
				<h3>Operation - put cash</h3>
				<form action="putcash" method="post">
					<h4>Input sum of each denomination banknotes which you wish enter. Banknote that you don't want put, you have to specify 0 in the field.</h4>
					<table width="50%" cellspacing="0" cellpadding="2">
						...
						<tr>
							<td></td>
							<td><input class="styleB" type="submit" value="Put"></td>
						</tr>
					</table>
				</form>
